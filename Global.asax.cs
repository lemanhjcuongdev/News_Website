    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            newslist.Add(new News(8,
                ...
                "Trong bộ tứ iPhone 14, dự kiến ra mắt vào tháng 9, cặp iPhone 14 Pro/ iPhone 14 Pro Max là tâm điểm của sự chú ý. Chúng được dự đoán là 2 trong số những smartphone tốt nhất của năm nay với nhiều thay đổi, nâng cấp từ trong ra ngoài." +
